...
<h1 style="text-align: center">Ajouter un jeu 🤘</h1>

<form action="add.php" method="post" class="mx-auto" style="background-color: #8a704b ; border: solid ; border-radius: 5px ; width: 40% ; text-align: center ; padding: 3rem ; margin-top: 3rem">
        ...
        <input type="text" id="genreGame_input" name="genreGame_input" />
            ...
            <div class="mb-3">
            <label for="ratingGame">Rating</label>
            <input type="number" id="ratingGame_input" name="ratingGame_input" />




    <input type="submit" value="Ajouter le jeu" onclick="alert('Le jeu est bien ajouté 👍')" />
</form>


<?php if (isset($_POST['nameGame_input'])
